      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 py-10 text-sm text-text-muted">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          ...
          <div className="flex gap-5">
            <a href="https://github.com/" target="_blank" className="hover:text-text">GitHub</a>
            <a href="https://www.linkedin.com/" target="_blank" className="hover:text-text">LinkedIn</a>
